        ...
        <div className="prose prose-lg max-w-none space-y-6">
            ...
            <ol className="list-decimal list-inside space-y-2 text-gray-700 ml-4">
              <li>本サービスは、以下の機能を提供します：
                <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                  ...
                  <li>分析結果に基づく改善提案</li>
                  <li>AIチャット機能（戦略指南サブスクのみ）</li>
                </ul>
              </li>
              <li>本サービスには以下のプランがあります：
                <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                  <li><strong>無料お試しプラン</strong>：AB3C分析および改善提案を1回まで利用可能</li>
                  <li><strong>戦略診断チケット</strong>：購入から1年間有効。購入したサイト数分のAB3C分析を利用可能（チャット機能なし・ワンショット利用）</li>
                  <li><strong>戦略指南サブスク（戦略診断・策定・アクション）</strong>：月額制または年額制でAB3C分析およびAIチャット機能を利用可能</li>
                </ul>
              </li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2 text-gray-700 ml-4">
              ...
              <li><strong>一度支払われた料金は返金いたしません。</strong>ただし、当協会の責に帰すべき事由により本サービスが正常に提供されなかった場合、および二重決済等の明らかな決済エラーが発生した場合はこの限りではありません。</li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2 text-gray-700 ml-4">
              ...
              <li>月額プランを解約した場合、次回更新日までは現在のプランを利用できます。</li>
              <li>年額プランは、契約期間の途中で解約し料金の返金を受けることはできません。更新を停止した場合も、契約期間の満了までは現在のプランを利用できます。</li>
