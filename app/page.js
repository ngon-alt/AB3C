...
<div style={{ display: "flex", gap: 8 }}>
          ...
          {/* メッセージ */}
<div style={{ height: fullscreen ? "calc(100vh - 180px)" : 280, overflowY: "auto", padding: 16, display: "flex", flexDirection: "column", gap: 12, background: C.bg }}>              <div key={i} style={{ display: "flex", justifyContent: m.role === "user" ? "flex-end" : "flex-start" }}>
                <div style={{
