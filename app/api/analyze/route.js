  ...
  "three_c": {
    "customer": {
      ...
      "market": {
        ...
        "basis": "算出根拠（公的統計・業界レポートからの引用の場合は出典名と年度を明記。フェルミ推定の場合はベースとなる数字と計算過程を簡潔に説明。例：『経済産業省DXレポート2024によると国内DX市場は約3.4兆円。うちコンサルティング領域は約15%の5,100億円。中小企業向けは約30%と推定し、SAM≒1,500億円』）"
      }
    },
    "competitor": {
