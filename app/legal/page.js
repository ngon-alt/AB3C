        ...
        <div className="space-y-8">
          ...
          <section className="border-b border-gray-200 pb-6">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <div>
                <h3 className="font-semibold mb-2">戦略指南サブスク（戦略診断・策定・アクション・月額/年額・チャット機能付き）</h3>
                <ul className="list-disc list-inside ml-4 space-y-1">
              ...
              <p className="text-sm text-gray-600 mt-4">
                ※上記金額は全て税込表示です。<br />
                ※戦略指南サブスクの年額は月額×10ヶ月分の料金で12ヶ月ご利用いただけます（2ヶ月分無料）。
              </p>
            </div>
          </section>
          ...
          <section className="border-b border-gray-200 pb-6">
            ...
            <div className="space-y-2 text-gray-700">
              ...
              <p className="mt-2">月額プランの解約はいつでも可能です。解約後も次回更新日までは現在のプランをご利用いただけます。</p>
              <p>年額プランは契約期間の途中で解約・返金することはできません。更新を停止した場合も、契約期間の満了まではご利用いただけます。</p>
            </div>
          </section>
