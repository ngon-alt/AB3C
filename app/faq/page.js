...
const faqs = [
  ...
  },
  {
    ...
    items: [
      {
        q: "無料で使えますか？",
        a: "はい。Googleアカウントでログインすると、AB3C分析レポート1回、ウェブサイト改善レポート1回、AIチャット相談1回を無料で体験できます。クレジットカード不要です。",
      },
      {
        q: "スポットプランとサブスクプランの違いは？",
        a: "スポットプランは年間ライセンスで、AB3C分析レポートとウェブサイト改善レポートの生成、AIチャット相談30回が含まれます。サブスクプランは月額/年額で、分析機能に加えて10施策のAI伴走チャットが使い放題（月100回/サイト）になります。",
      },
      {
        q: "50%OFFキャンペーンとは？",
      ...
      {
        q: "複数サイトを管理できますか？",
        a: "はい。プランに応じてサイト数の上限が異なります。スポットプランは1/10/100サイト、サブスクプランは1/5/15/30/60/120サイトから選択できます。サイト管理画面で複数サイトを一元管理し、切り替えて分析・伴走ができます。",
      },
      {
        q: "返金保証はありますか？",
