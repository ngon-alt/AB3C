...
const faqs = [
  ...
  },
  {
    ...
    items: [
      {
        q: "無料で使えますか？",
        a: "はい。Googleアカウントでログインすると、AB3C分析レポートとウェブサイト改善レポートを1回無料で体験できます。クレジットカード不要です。AIチャットや戦略アクション機能はフルプランで利用可能です。",
      },
      {
        q: "戦略診断プランとフルプランの違いは？",
        a: "戦略診断プラン（有効期限1年）はAB3C分析レポートとウェブサイト改善レポートの生成のみで、結果はPDF・印刷・シェアURLで持ち帰る一発診断のプランです。診断結果は履歴保存されないため、必ず持ち帰ってください。購入したサイト数分の診断は1年以内に使い切る必要があります。フルプラン（戦略診断・策定・アクションプラン、月額/年額）は診断に加えて、AIチャットで戦略を磨く（戦略策定）、10施策テーマでアクションを検討する（戦略アクション）ところまで継続的に使えます。診断結果や戦略確定履歴も保存されます。",
      },
      {
        q: "50%OFFキャンペーンとは？",
      ...
      {
        q: "複数サイトを管理できますか？",
        a: "はい。プランに応じてサイト数の上限が異なります。戦略診断プランは1/10/100サイト、フルプランは1/5/15/30/60/120サイトから選択できます。サイト管理画面で複数サイトを一元管理し、切り替えて分析・戦略策定ができます。",
      },
      {
        q: "返金保証はありますか？",
