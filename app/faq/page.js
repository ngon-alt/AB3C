...
const faqs = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "戦略診断プランとフルプランの違いは？",
        a: "戦略診断プラン（年間ライセンス）はAB3C分析レポートとウェブサイト改善レポートの生成のみで、結果はPDF・印刷・シェアURLで持ち帰る一発診断のプランです。フルプラン（戦略診断・策定・アクションプラン、月額/年額）は診断に加えて、AIチャットで戦略を磨く（戦略策定）、10施策テーマでアクションを検討する（戦略アクション）ところまで継続的に使えます。",
      },
      {
        q: "50%OFFキャンペーンとは？",
