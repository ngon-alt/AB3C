...
const faqs = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "分析プランと伴走プランの違いは？",
        a: "分析プランは年間ライセンスで、AB3C分析レポートとウェブサイト改善レポートの生成、AIチャット相談30回が含まれます。伴走プランは月額/年額で、分析機能に加えて10施策のAI伴走チャットが使い放題（月100回/サイト）になります。",
      },
      {
        q: "50%OFFキャンペーンとは？",
      ...
      {
        q: "複数サイトを管理できますか？",
        a: "はい。プランに応じてサイト数の上限が異なります。分析プランは1/10/100サイト、伴走プランは1/5/15/30/60/120サイトから選択できます。サイト管理画面で複数サイトを一元管理し、切り替えて分析・伴走ができます。",
      },
      {
        q: "返金保証はありますか？",
