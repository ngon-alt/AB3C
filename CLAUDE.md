...
- 旧「分析プラン」→ **スポットプラン**
- 旧「伴走プラン」→ **サブスクプラン**
- タブ名: 旧「分析」→ **戦略立案**、旧「伴走」→ **戦略アクション**

### スポットプラン（年間ライセンス・有効期限1年・チャットなし・ワンショット利用）
...
### サブスクプラン（月額/年額・AIチャット付き・戦略アクション利用可・1サイト月100回上限）
...
- 3ヶ月返金保証あり
- **Stripe Price IDは新価格で再作成が必要（2025/04/15時点で旧価格のまま）**
- 無料トライアル: 分析1回（チャットなし、スポット利用と同じ体験）
